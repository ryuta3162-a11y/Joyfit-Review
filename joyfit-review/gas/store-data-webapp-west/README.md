...
| ポイント付与管理 | `https://script.google.com/macros/s/AKfycbxMrMSZe8XdD869thfm1DD0EsoGDe5MC7s2Sctf48oblffvb-6bcCRMuN2Y7YHv0a0j/exec?page=points` |
...
1. `店舗データ` … 列ルールどおりのヘッダー
2. `_survey_dedup` / `_survey_member_codes` … 補助
