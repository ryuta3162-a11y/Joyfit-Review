              ...
              >
                <div
                  ...
                  style={
                    isFit365
                      ? {
                          background: `linear-gradient(135deg, ${theme.primary} 0%, ${theme.primarySoft} 55%, #ffffff 140%)`,
                        }
                      : {
                          background: `linear-gradient(135deg, ${theme.primaryDark} 0%, ${theme.primary} 55%, ${theme.primarySoft} 100%)`,
                        }
                  }
                >
